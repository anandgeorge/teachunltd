...
const ContentImageEditScreen = ({ match, history }) => {
  ...
  useEffect(() => {
    if (successUpdate) {
      ...
      // console.log('Contents in contentImageEditScreen', newContent)
      dispatch({
  ...
  const uploadFileHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post('https://api.teachun.ltd/api/upload/image', formData, config)
...
export default ContentImageEditScreen
