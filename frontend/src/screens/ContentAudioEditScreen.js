...
const ContentAudioEditScreen = ({ match, history }) => {
  ...
  const uploadFileHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post('https://api.teachun.ltd/api/upload/audio', formData, config)
...
export default ContentAudioEditScreen
